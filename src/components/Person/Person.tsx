...
export const Person: React.FC<Props> = (props) => {
  ...
  return (
    <tr className="people__person person">
      ...
      <td className="person__cell">{person.motherName ? person.motherName : <b>Unknown</b>}</td>
      <td className="person__cell">{person.fatherName ? person.fatherName : <b>Unknown</b>}</td>
    </tr>
  );
};
