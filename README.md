...
- Replace `DenNice-cloud` with your Github username in the [DEMO LINK](https://DenNice-cloud.github.io/react_people-table-basics/) and add it to the PR description.
