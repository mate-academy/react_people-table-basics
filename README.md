...
1. Make each name in the table a link a to `/people/:slug` (including mother and father)
    - create the `<Person person={person} />` and use it for all existing people;
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://Radymyr.github.io/react_people-table-basics/) and add it to the PR description.
