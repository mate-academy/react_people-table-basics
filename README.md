...
1.
1. Create the Create the `HomePage` available at `/` with just a title `Home Page``PeoplePage` available at `/people` with a title `People Page`
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://sapnachoudhary06.github.io/react_people-table-basics/) and add it to the PR description.
