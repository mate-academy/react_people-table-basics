...
1. Pass `people` to `PeopleList` component and render as a table (see the given markup);
1. Make each name in the table a link to `/people/:slug` (including mother and father)
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://andriibezkorovainyi.github.io/react_people-table-basics/) and add it to the PR description.
