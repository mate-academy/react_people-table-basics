...
1. Use [Navigate](https://reactrouter.com/docs/en/v6/components/navigate) component to redirect from `/home` to `/`;
    - add `replace` attribute not to save `/home` URL in the [browser history](httxps://reactrouter.com/en/main/start/tutorial#managing-the-history-stack) and avoid navigation loop when you press browser `Go back` button.
...
- Replace `radykhovska` with your Github username in the [DEMO LINK](https://radykhovska.github.io/react_people-table-basics/) and add it to the PR description.
