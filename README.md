...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://AndriiMysheniuk.github.io/react_people-table-basics/) and add it to the PR description.
