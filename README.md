...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://max-rozzhalovets.github.io/react_people-table-basics/) and add it to the PR description.
