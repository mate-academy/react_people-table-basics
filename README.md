...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://aakash1sadhu.github.io/react_people-table-basics/) and add it to the PR description.
