...
> Here is [the working example](https://manpte-academy.github.io/react_people-table-basics/)
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://artem-hirzhev.github.io/react_people-table-basics/) and add it to the PR description.
