...
- Replace `<your_account>` with your GitHub username in the [DEMO LINK](https://kamal-tufekcic.github.io/react_people-table-basics/) and add it to the PR description.
