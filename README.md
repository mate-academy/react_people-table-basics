...
- Replace `Irina-Kulish` with your Github username in the [DEMO LINK](https://Irina-Kulish.github.io/react_people-table-basics/) and add it to the PR description.
