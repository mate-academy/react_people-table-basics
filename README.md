...
1. Add the `Navbar` with 2 links `Home` and `People`. Active one should have the `  ` class;
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://ivxvi.github.io/react_people-table-basics/) and add it to the PR description.
