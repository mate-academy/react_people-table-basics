...
1. Use [Navigate](https://reactrouter.com/en/6.10.0/components/navigate) component to redirect from `/home` to `/`;
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://d-hubych.github.io/react_people-table-basics/) and add it to the PR description.
