...
Implement the `App` with 2 pages and   to select a person in the table.
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://Dorosh90.github.io/react_people-table-basics/) and add it to the PR description.
